...
# 直接从main.py导入
from astrbot_plugin_memory_capsule.main import store_plugin_data, query_plugin_data, get_memory_manager
...
def test_query_data():
    ...
    bili_data = query_plugin_data("", "bilibili_watcher")
